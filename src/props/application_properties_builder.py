...
class ApplicationPropertiesBuilder:
    ...
    def prepare_application_properties_v_core_1_logic_0_depend_1(is_debug_on=False):
        ...
        ocr_properties = OCRProperties(
            ...
            prices_ocr_property=OCRProperty(config='--psm 8 -c tessedit_char_whitelist=.0123456789', lang=None),
            amounts_ocr_property=OCRProperty(config='--psm 8 -c tessedit_char_whitelist=.0123456789', lang=None),
